  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-md mx-auto bg-background min-h-screen">
        ...
        <div className="p-4 space-y-4">
          ...
          <Card className="bg-card rounded-2xl shadow-xl border border-border">
            <CardContent className="p-6">
              <h3 className="font-bold text-card-foreground mb-4">Services</h3>
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-card-foreground">Our Services</div>
                      <div className="text-sm text-muted-foreground">Explore available services</div>
                    </div>
                ...
                <Button
                  variant="ghost"
                  className="w-full justify-start text-left p-4 h-auto hover:bg-card/50 rounded-2xl"
                  onClick={() => handleNavigation('/rewards-offers')}
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-card-foreground">Rewards & Offers</div>
                      <div className="text-sm text-muted-foreground">View available rewards</div>
                    </div>
                    <i className="fas fa-chevron-right text-muted-foreground"></i>
                  </div>
                </Button>
        ...
        {/* Bottom Navigation */}
        <Navigation currentPage="more" userRole="customer" />
      </div>
    </div>
  );
}
