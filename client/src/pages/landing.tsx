                ...
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    <div className={`w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4 ${
                      selectedRole === 'customer' ? 'bg-blue-100' :
                      selectedRole === 'freelancer' ? 'bg-green-100' : 'bg-purple-100'
                    }`}>
                      <i className={`text-2xl ${
                        selectedRole === 'customer' ? 'fas fa-search text-blue-600' :
                        selectedRole === 'freelancer' ? 'fas fa-hammer text-green-600' : 'fas fa-cog text-primary'
                      }`}></i>
                    </div>
